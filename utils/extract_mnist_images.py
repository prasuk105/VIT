...
if __name__ == '__main__':
    extract_images('data/train/images', 'C:/Users/prasuk jain\VIT/data/mnist_train.csv')
    extract_images('data/test/images', 'C:/Users/prasuk jain\VIT/data/mnist_test.csv')